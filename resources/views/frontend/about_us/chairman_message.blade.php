...
<body class="skin-light fixed black-heading about-us" style="background: #eaeaea">
    ...
    <section class=" dark full-height dark transparent" style="">
        <!-- <div class="owl-carousel owl-theme" id="bgslider">
            <div class="item">
                <img src="{{ url ('assests/images/home-slid1.jpg') }}" />
            </div>
            <div class="item">
                <img src="{{ url ('assests/images/home-slid2.jpg') }}" />
            </div>
        </div> -->
        <!-- menu header-->
                ...
                <div class="row h-100">
                    ...
                    <div class="col-lg-3 col-12  justify-content-center align-self-center ">
                        <div class="ul-dropdown">
                            <div class="selected">Chairman's Message</div>
                            ...
                            <div class="col-lg-9 col-md-12 col-sm-12">
                                @if($aboutus_contents->first() != null)
                                    <div class="content-area">
                                        <h2 class="lato-black text-uppercase mb-4">{{$aboutus_contents->first()->content_heading}}</h2>
                                        <p class="font-16">{!! $aboutus_contents->first()->content_description !!}</p>
                                    </div>
                                @endif
                            </div>
    ...
    @endsection
    @section('title','Almawashi | About Us | Chairmain Message') 