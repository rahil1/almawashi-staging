...
<body class="skin-black fixed our-quality" style="background: #282828">
        ...
        <div id="main-content" class="">
            <div class="container-fluid h-100">
                ...
                <div class="row h-100">
                    ...
                    <!-- end left links -->
                    <!-- right content -->
                    <div class="col-lg-9 col-12-9">
                        <div class="content-area">
                            <h2 class="lato-black text-uppercase while mb-4">ISO</h2>
                            <div class="owl-carousel owl-theme scroll iso box-shadow">
    ...
    @endsection
    @section('title','Almawashi | Quality | ISO') 