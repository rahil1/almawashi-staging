    ...
    <div id="main-content" class="m-0">
        ...
        <div class="page-section" style="background: #f5f5f5">
            <div class="container-fluid">
                    ...
                    <div class="row mb-5 pl-4 pl-mb-0">
                        <div class="col-12">
                            <div class="content-area">
                                <h2 class="color-theme style2 mb-3 d-block d-md-none">Shipping</h2>
                            </div>
                        </div>
                        <!-- content -->
                        <div class="col-lg-4 col-md-6 col-sm-12 align-self-center order-2 order-md-1">
                            <div class="content-area  pl-lg-5 pl-md-5">
                                <h2 class="color-theme style2 mb-3 d-none d-md-block">Shipping</h2>
                ...
                @if($services->get(1) != null)
                    <div class="row mb-5 pl-4 pl-mb-0">
                        <!-- image box -->
                        <div class="col-lg-5 col-md-6 col-sm-12 mb-sm-5 mb-4 mb-mb-0">
                            <div class="image-box">
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-12 align-self-center">
                            <div class="content-area">
                                ...
                                <a href="{{ $services->get(1)->service_read_more_link }}">Contact us for further Enquiries</a>
                            </div>
                        </div>
                    </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-7 col-md-12 mx-auto">
                        <h2 class="font-32 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="page-section" style="background: #f5f5f5">
            <div class="container-fluid"> 
                    <div class="row mb-5 pl-4 pl-mb-0">
                        <!-- content -->
                        <div class="col-lg-6 col-md-6 col-sm-12 align-self-center order-2 order-mb-1">
                            <div class="content-area">
                                <p>{!! $services->get(2)->service_description !!}</p>
                            </div>
                        </div>
                        <!-- image box -->
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-4 mb-mb-0 order-1 order-mb-2">
                            <div class="image-box">
        ...
        @endsection
        @section('title','Almawashi | Services | Shipping')