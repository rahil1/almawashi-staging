...
<body class="dark-skin">
    ...
    <div id="main-content" class="m-0">
                    ...
                    <div class="row mb-5 pl-4 pl-mb-0">
                        <div class="col-12">
                            <div class="content-area">
                                <h2 class="color-theme style2 mb-3 d-block d-md-none">Food Service</h2>
                            </div>
                        </div>
                        <!-- content -->
                        <div class="col-lg-4 col-md-6 col-sm-12 align-self-center order-2 order-md-1">
                            <div class="content-area  pl-lg-5 pl-md-5">
                                <h2 class="color-theme style2 mb-3 mb-3 d-none d-md-block">Food Service</h2>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-7 col-md-12 mx-auto">
                        <h2 class="font-32 text-center">Al Mawashi ensures the best quality of products to our customers</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        @endsection
        @section('title','Almawashi | Services | Food Service')