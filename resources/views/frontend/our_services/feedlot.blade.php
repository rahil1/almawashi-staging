    ...
    <div id="main-content" class="m-0">
        ...
        <div class="page-section" style="background: #f5f5f5">
            <div class="container-fluid">
                    ...
                    <div class="row mb-5 pl-4 pl-mb-0">
                        <div class="col-12">
                            <div class="content-area">
                                <h2 class="color-theme style2 mb-3 d-block d-md-none">Feedlot</h2>
                            </div>
                        </div>
                        <!-- content -->
                        <div class="col-lg-4 col-md-6 col-sm-12 align-self-center order-2 order-md-1">
                            <div class="content-area  pl-lg-5 pl-md-5 ">
                                <h2 class="color-theme style2 mb-3 d-none d-md-block">Feedlot</h2>
                                    <p>{!! $services->first()->service_description !!}</p>
                            </div>
                        </div>
                        <!-- image box -->
                        <div class="col-lg-8 col-md-6 col-sm-12 mb-4 mb-mb-0 order-1 order-md-2">
                ...
                @if($services->get(1) != null)
                    <div class="row mb-5 pl-4 pl-mb-0">
                        <!-- image box -->
                        <div class="col-lg-5 col-md-6 col-sm-12 mb-sm-5">
                            <div class="image-box">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-7 col-md-12 mx-auto">
                        <h2 class="font-32 text-center">Our feedlots are state of the art facilities to ensure the best environment to the animals </h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="page-section" style="background: #f5f5f5">
            <div class="container-fluid">
                    <div class="row mb-5 pl-4 pl-mb-0">
                        <!-- content -->
                        <div class="col-lg-6 col-md-6 col-sm-12 align-self-center order-2 order-md-1">
                            <div class="content-area">
                                <p>{!! $services->get(2)->service_description !!}</p>
                                <a href="{{ $services->get(2)->service_read_more_link }}">Contact us for Rental Enquiries</a>
                            </div>
                        </div>
                        <!-- image box -->
                        <div class="col-lg-6 col-md-6 col-sm-12 mt-sm-5 mb-4 mb-mb-0  order-1 order-md-2">
                            <div class="image-box">
        ...
        @endsection
        @section('title','Almawashi | Services | Feedlot')